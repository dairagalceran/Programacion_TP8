...
public class MainJugueteria {
    public static void main(String[] args) {
        ...
        Pieza ladrillito = new Pieza("star", "azul", 600.20, 3, 19);
        Pieza ladrillito4 = new Pieza("rasti", "rojo", 600.20, 3.2, 10);
        Pieza ladrillito3 = new Pieza("rasti", "verde", 140.20, 1.3, 15);
        Pieza ladrillito2 = new Pieza("star", "amarillo", 170.20, 3.4, 13);
       ...
       // combo1.addPiezasAlCombo(combo1);
        ...
        CondicionBusqueda peso = new BusquedaPorMenorPeso(3.3);
        BusquedaPorMenorCantidadEncastre cantEnc = new BusquedaPorMenorCantidadEncastre(15);
        ArrayList<ElementoAdmin> buscar = lib.buscarPor(cantEnc);
        System.out.println(buscar);
        System.out.println();
        System.out.println("-------orden --------");
        OrdenPorMarca ordenMarca = new OrdenPorMarca();
        OrdenPorCosto ordenCosto = new OrdenPorCosto();
        OrdenCantidadEncastre ordenCant = new OrdenCantidadEncastre();
        OrdenDoble ordenDoble = new OrdenDoble( ordenCosto, ordenMarca);
        ArrayList<ElementoAdmin> buscarOrdenados = lib.buscarPor(cantEnc, ordenCant);
        ...
        System.out.println("-------copia combo 2");
        System.out.println(combo1.getCopia());
